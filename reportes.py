                    ...
                    if digito_22 == '0' and (pd.isna(matricula) or matricula == '' or matricula == 0):
                        ...
                        for _, propietario in propietarios_ficha.iterrows():
                            ...
                            if calidad not in ['4|MUNICIPAL', '2|NACIONAL']:
                                cantidad_registros += 1
                                break  # Contar solo una vez por NroFicha si cumple

            print(f"Total de registros encontrados: {cantidad_registros}")

            # Crear un único DataFrame con el resumen
            resumen = {
                'Observacion': 'El predio es NPH , la matricula es 0 y el propietario es diferente de la Nacion o el municipio',
                'Cantidad': cantidad_registros,
                'Nombre Hoja': 'Reportes'
            }
